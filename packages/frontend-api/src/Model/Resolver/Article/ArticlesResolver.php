...
class ArticlesResolver implements ResolverInterface, AliasedInterface
{
    ...
    public function resolve(Argument $argument, ?string $placement)
    {
        ...
        $paginator = new Paginator(function ($offset, $limit) use ($domainId, $placement) {
            return $this->getArticlesLimited($domainId, $limit, $offset, $placement);
        });
     ...
     */
    protected function getArticlesLimited(
        int $domainId,
        int $limit,
        int $offset,
        ?string $placement
        ...
        if ($placement !== null) {
            return $this->articleFacade->getVisibleArticlesForPlacementByDomainIdLimited(
                $domainId,
                $placement,
                $limit,
                $offset
        ...
        return $this->articleFacade->getVisibleArticlesSortedByPlacementAndPositionByDomainIdLimited(
            $domainId,
            $limit,
            $offset
        );
