...
class ArticleRepository
{
     ...
     * @return \Shopsys\FrameworkBundle\Model\Article\Article[]
     */
    public function getVisibleArticlesByDomainIdAndPlacementSortedByPositionLimited(
        int $domainId,
        string $placement,
        int $limit,
        int $offset
     ...
     * @return \Shopsys\FrameworkBundle\Model\Article\Article[]
     */
    public function getVisibleSortedByPlacementAndPositionByDomainIdLimited(
        int $domainId,
        int $limit,
        int $offset
    ): array {
